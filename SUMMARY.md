...
- **Key Screens:**
  - **Dashboard:** Real-time transaction monitoring, fraud statistics, risk distribution charts
  - **Transaction Simulator:** Test fraud detection with QR code scanning and form-based input
  - **Risk Gauge:** Animated circular progress indicator showing transaction risk score
  - **API Console:** Developer testing interface
  - **Profile Management:** User account settings and device management
...
- Call-to-action buttons to test the system
- Social proof and use case highlights
...
#### 4. Profile Page
- Guardian management for senior users
